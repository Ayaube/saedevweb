...
class ClassementModel extends Connexion {
    ...
    public function getData() {
        try{
            $stmt = self::$bdd->prepare('SELECT DISTINCT Joueur.username, joueur_partie.map, joueur_partie.vague_atteinte, joueur_partie.ennemis_tue, joueur_partie.argent_gagne
    FROM (
